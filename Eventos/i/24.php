            ...
            <div class="row">
              <div class="cs-top-links-strip">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                  <div class="cs-top-text"> Federación Internacional de Fisicoculturismo - Colombia </div>
                </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6" style="margin-top:30px;">
            <div class="cs-quick-links" style="background: url(assets/extra-images/quick-bg1.png) no-repeat; background-size:cover; height:350px;">
              <div class="cs-text">
                <h4><?=$Nombre?></h4>
                <br/><br/><br/>
                <div class="button-style"> <a href="culturismo.html" class="custom-btn large-btn cs-bgcolor">Ampliar</a> </div>
              </div>
            </div>
          </div>
          <?}?>
