		...
		<div class="page-section">
			<div class="container">
				<div class="row">
					...
					<?
            		$query     =  "SELECT * FROM EventosR ORDER BY Pos";
                    ...
                    <div class="call-actions ac-modren">
						<div class="inner-sec" style="background: url(assets/extra-images/bg-cell-action.jpg) no-repeat 0 0 / cover;">
							...
							<div class="cell call-btn">
								<a href="#"><i class="fa fa-file-text"></i> Resultados</a>
							</div>
						</div>
                    </div>
                    <?}?>    
						...
						<div class="page-sidebar">
							<div class="widget widget-categories">
								...
								<ul>
									...
									<li class="active1"> <i class="fa fa-check-square-o"></i>  <a href="resultados.php">Resultados</a>  </li>
                    ...
                    <div class="widget widget-recentpost">
                      ...
                      <div>
                         ...
                         <div class="cs-text">
                          <h6><a href="detalles.html"><?=$Nombre3?></a></h6>
