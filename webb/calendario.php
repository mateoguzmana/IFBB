...
<div class="wrapper wrapper_boxed"> 
	...
	<div id="main">
		<div class="page-section">
						...
						<div class="div-content">
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="map-area">
									 <img width="100%" src="assets/extra-images/eventod.jpg"/>
									</div>
								</div>
							...
							<thead >
                            <tr >								
								<th style="background-color:#8a000c;"><span style="font-size:14px;">Evento</span></th>
								<th style="background-color:#8a000c;"><span style="font-size:14px;">Fecha</span></th>
                                <th style="background-color:#8a000c;"><span style="font-size:14px;">Lugar</span></th>
                                <th style="background-color:#8a000c;"><span style="font-size:14px;">Información</span></th>
                              									
							</tr></thead>
					
						<tbody>
            <?
            $query     =  "SELECT * FROM EventosC ORDER BY Pos";
            ...
            ?>
            <tr>
							<td><span style="font-size:12px;"><?=$Nombre?></span></td>
							<td> <span style="font-size:12px;"><?=$Fecha?></span></td>
              <td><span style="font-size:12px;"><?=$Lugar?></span></td>
              <td style="text-align:center;" >      <a target="_blank" href="../Eventos/c/<?=$Archivo?>"><i class="fa fa-map-o"></i></a> </td>
						</tr>
            <?}?>
					</tbody>
        </table>
					...
					<aside class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<div class="page-sidebar">
							<div class="widget widget-categories">
								...
								<ul>
										<li class="active1" > <i class="fa fa-check-square-o"></i>  <a href="calendario.php">Calendario</a>  </li>
									<li > <i class="fa fa-check-square-o"></i>  <a href="resultados.php">Resultados</a>  </li>
									<li> <i class="fa fa-check-square-o"></i>  <a href="invitaciones.php">Invitaciones</a>  </li>
