						...
						<div class="div-content">
							<div class="row">
								<div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<?
									$query  	=  "SELECT * FROM ReglamentoI ORDER BY Pos";
                    				...
                    				<div class="call-actions ac-modren">
										<div class="inner-sec" style="background: url(assets/extra-images/bg-cell-action.jpg) no-repeat 0 0 / cover;">
											...
											<a class="example-image-link" href="../Reglamento/i/<?=$Archivo?>"  data-lightbox="example-set" data-title="">	<i class="fa fa-file-text"></i> Ampliar</a>
											</div>
										</div>
                    				</div>
                    				<?}?>
					...
					<aside class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						<div class="page-sidebar">
							<div class="widget widget-categories">
                               ...
                               <li class="active1"> <i class="fa fa-check-square-o"></i> <a href="infografias.php">Infografías</a></li>
