...
$query0001="SELECT* FROM Internas where Id = '$Id'" ;
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingfotoint.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actfotoint3.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="50%"><span class="Estilo93">Foto JPG</span><br>
                      <span class="Estilo93" style="font-size: 8px"><img src="../Internas/<?=$Foto?>" width="100" height="83"></span>
