...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingnoticia2.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"><br>
                  ...
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto Grande JPG </span><br>
