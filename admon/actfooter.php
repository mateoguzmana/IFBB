...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actfooter2.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">FOOTER</span><br>
                      <input name="Texto" type="text" class="TextField22" id="Texto" style="width:95%" value="<?=$Texto?>">                      <input name="Id" type="hidden" id="Id" value="<?=$Id0001?>">                      <br></td>
                    </tr>
                </table>
                <br>
                <br>
