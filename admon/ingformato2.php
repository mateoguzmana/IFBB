...
$sql="INSERT INTO  ReglamentoM (Nombre)";
$sql.= "VALUES ('$Nombre')";
mysql_query($sql);


$query="SELECT* FROM ReglamentoM Order By Id Asc";
...
(copy($archivo2, "../Reglamento/m/".$foto0));

$query="UPDATE ReglamentoM set Archivo='$foto0' Where Id='$Id'";
$result=mysql_query($query, $id);
}
?>
