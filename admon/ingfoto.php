...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingfoto2.php" method="post" enctype="multipart/form-data" name="fcalen">
...
?>
                        <option value="<?=$Id0001?>"><?=$Nombre0001?></option>
<?
}
?>
                      </select>                      
                    ...
                    <td width="50%"><span class="Estilo93">Titulo</span><br>
                      <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:95%"></td>
                  </tr>
                </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
