...
<div class="wrapper wrapper_boxed"> 
  ...
  <div id="main"> 
<!--large-->
    <div class="page-section" style="margin:0;">
      <div class="container"> 
      	<div class="cs-gallery large">
          <div class="row">
            <?
            $query       =  "SELECT * FROM Categorias ORDER BY Pos ";
            ...
            $query2      =  "SELECT * FROM Imagenes WHERE Idcat='$Id'";
            ...
            <article class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="cs-gallery-content">
                <h4><?=$Nombre?></h4>
                <div class="cs-media">
                <a href="galerias.php?Id=<?=$Id?>"><figure><img alt="blog-grid" src="../Categorias/<?=$Foto?>" class="img-responsive">
                    <figcaption></figcaption>
                  </figure></a>
                  <div class="cs-total-photo"> <a href="galerias.php?Id=<?=$Id?>"> <?=$Fx?> Fotos </a> </div>
                </div>
              </div>
            </article>
            <?}?>
