...
$(document).ready(function(){ 	
  ...
  $("#response").slideUp("slow", function () {
	...
	$("#list ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			var order = $(this).sortable("serialize") + '&update=update&tabla=Banner'; 
...
<ul>  
        ...
        <?
$query0001="SELECT* FROM Banner order by Pos" ;
...
<li id="arrayorder_<?php echo $Id0001 ?>">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="75%" valign="middle" bgcolor="#EFEFEF"><span class="Estilo93" style="font-size: 8px"><img src="../slider/<?=$Foto0001?>" width="111" height="39"><br>
          <?=$Nombre0001?></span></td>
