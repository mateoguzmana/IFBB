...
$query0001="SELECT* FROM EventosC where Id = '$Id'" ;
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
  <tr valign="middle" bordercolor="#FFFFFF">
    <td height="132" align="center" bordercolor="#F2F2F2"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="62" valign="top"><form action="actcalendario3.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
              <td width="20%" align="right"><a href="ingcalendario.php" class="Estilo93">Ingresar nuevo</a></td>
            </tr>
          </table>
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                    ...
                    <td height="30"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="30"><span class="Estilo93">Nombre</span><br>
                          <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:99%" value="<?=$Nombre0001?>" ></td>
                        <td width="50%"><span class="Estilo93">Fecha</span><br>
                          <input name="Fecha" type="text" class="TextField22" id="Fecha" style="width:99%" value="<?=$Fecha?>" ></td>
                      </tr>
                    </table>
                      <br>
                      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <td width="50%" height="30"><span class="Estilo93">Lugar</span><br>
                          <input name="Lugar" type="text" class="TextField22" id="Lugar" style="width:99%" value="<?=$Lugar?>" ></td>
						...
						{
						?>
                        <span class="Estilo93">(<a href="../Eventos/c/<?=$Archivo?>" target="_blank">ver archivo</a> ) </span>
                        <?
						}
						?>
