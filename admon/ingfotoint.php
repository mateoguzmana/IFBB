...
{
     if (form.file1.value == "")
  { alert("Por favor ingrese una Imagen"); form.file1.focus(); return; }
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingfotoint2.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Titulo</span><br>
                      <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:95%">                      <br></td>
                    <td width="50%"><span class="Estilo93">Foto JPG</span><br>
                      <input name="file1" type="file" class="TextField22" id="file1">
                      <span class="Estilo93">                      (400x270) px</span></td>
                  </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">Link (Poner siempre http://)</span><br>
                      <input name="Link" type="text" class="TextField22" id="Link" style="width:95%"></td>
                    </tr>
                </table>
<br>
                <br>
