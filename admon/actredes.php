          ...
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">TWITER</span><br>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">INSTAGRAM </span><br>
                      <input name="It" type="text" class="TextField22" id="Fl" style="width:95%" value="<?=$It?>">
                      <br></td>
                  </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">YOUTUBE </span><br>
                      <input name="Yt" type="text" class="TextField22" id="Fl" style="width:95%" value="<?=$Yt?>">
                      <br></td>
                  </tr>
                </table>
                <br>
