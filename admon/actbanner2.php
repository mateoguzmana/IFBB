...
$query0001="SELECT* FROM Banner where Id = '$Id'" ;
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto JPG</span><br>
                      <span class="Estilo93" style="font-size: 8px"><img src="../slider/<?=$Foto?>" width="104" height="44"></span> <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br>
                      <input name="file1" type="file" class="TextField22" id="file1">
                      <span class="Estilo93">(1600x500) px</span></td>
