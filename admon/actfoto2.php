...
$query0001="SELECT* FROM Imagenes where Id = '$Id'" ;
...
$query0005		="SELECT* FROM Categorias WHERE Id = '$Idcat' order by Pos" ;
$result0005		=mysql_query($query0005, $id);

While($row0005	=mysql_fetch_array($result0005))
{
$Id0005				=$row0005["Id"];
$Nombre0005			=$row0005["Nombre"];
}
...
function Validar(form)
{
     ...
     if (form.Idcat.value == "")
  { alert("Por favor seleccione una categoria"); form.Idcat.focus(); return; }
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingfoto.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actfoto3.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Categoria</span><br>
                      <select name="Idcat" class="TextField22" id="Idcat" style="width:95%">
                        <option value="<?=$Id0005?>" selected><?=$Nombre0005?></option>
                        <?
...
?>
                    ...
                    <td width="50%"><span class="Estilo93">Titulo</span><br>
                      <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:95%" value="<?=$Nombre?>"></td>
                  </tr>
                </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="84"><span class="Estilo93">Foto JPG</span><br>
                      <span class="Estilo93" style="font-size: 8px"><img src="../Imagenes/p/<?=$Foto?>" width="104" height="44"></span> <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br>
                      <input name="file1" type="file" class="TextField22" id="file1">
                      <span class="Estilo93">(800x800) px</span></td>
