...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingpatro2.php" method="post" enctype="multipart/form-data" name="fcalen">
              ...
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"><br>
                  ...
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto JPG </span><br>
                      ...
                      <span class="Estilo93">(305x480) px</span></td>
                    </tr>
                </table>
                  <br>
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="30"><span class="Estilo93">Link</span><br>
                        <input name="Link" type="text" class="TextField22" id="Link" style="width:99%" ></td>
                    </tr>
                  </table>
                  <br>
<br>
