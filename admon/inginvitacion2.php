...
$sql="INSERT INTO  EventosI (Nombre, Fecha, Lugar)";
$sql.= "VALUES ('$Nombre', '$Fecha', '$Lugar')";
mysql_query($sql);


$query="SELECT* FROM EventosI Order By Id Asc";
...
(copy($archivo2, "../Eventos/i/".$foto0));

$query="UPDATE EventosI set Archivo='$foto0' Where Id='$Id'";
$result=mysql_query($query, $id);
}
?>
