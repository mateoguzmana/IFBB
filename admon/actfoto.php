        ...
        <tr>
          <td width="95%"><div align="left" class="Estilo92 Estilo94">
            <form name="form" id="form">
              <select name="jumpMenu" class="TextField22" id="jumpMenu" onChange="MM_jumpMenu('self',this,0)">
              
              <option value="actfoto.php"></option>

              
<?
$Idcat			=$_REQUEST["Idcat"];

$query0005		="SELECT* FROM Categorias order by Pos" ;
...
?>
                <option value="actfoto.php?Idcat=<?=$Id0005?>"><?=$Nombre0005?></option>
<?
}
?>
              </select>
          ...
          <td width="5%"><a href="actfoto.php?Idcat=<?=$Idcat?>" class="Estilo93">Refrescar</a></td>
        </tr>
      </table>
      <hr width="99%" size="1">
      <p> </p>
...
<ul>  
        ...
        <?
$query0001="SELECT* FROM Imagenes where Idcat = '$Idcat' order by Pos" ;
...
<li id="arrayorder_<?php echo $Id0001 ?>">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="75%" valign="middle" bgcolor="#EFEFEF"><span class="Estilo93" style="font-size: 8px"><img src="../Imagenes/p/<?=$Foto0001?>" width="70" height="47"><br>
          <?=$Nombre0001?></span></td>
          <td width="23%" align="center" valign="middle"><span class="Estilo93"><a href="actfoto2.php?Id=<?=$Id0001?>" target="empresa">Act</a> / <a onClick=' return confirmSubmit()' href="elifoto.php?Id=<?=$Id0001?>">Elim</a></span></td>
        </tr>
        <tr>
