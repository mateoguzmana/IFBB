...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingcat.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actcat3.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="50%"><span class="Estilo93">Pos</span><br>
                      <input name="Pos" type="text" class="TextField22" id="Pos" value="<?=$Pos?>" size="2"></td>
                  </tr>
                </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto JPG</span><br>
                      <span class="Estilo93" style="font-size: 8px"><img src="../Categorias/p/<?=$Foto?>" width="104" height="44"></span> <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br>
                      <input name="file1" type="file" class="TextField22" id="file1">
                      <span class="Estilo93">(715x315) px</span></td>
