...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
  <tr valign="middle" bordercolor="#FFFFFF">
    <td height="132" align="center" bordercolor="#F2F2F2"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="62" valign="top"><form action="actpubli3.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
              <td width="20%" align="right"><a href="ingpubli.php" class="Estilo93">Ingresar nuevo</a></td>
            </tr>
          </table>
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
...
Nombre <br>
                  ...
                  <br>
                  Fecha <br>
                  <input name="Fecha" type="text" class="TextField22" id="Fecha" value="<?=$Fecha?>"  style="width:99%">
<input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="30"><span class="Estilo93">Foto  JPG <br>
                          </span><span class="Estilo93" style="font-size: 8px"><img src="../Publicaciones/g/<?=$Foto?>" width="146" height="67"></span><br>
                          <input name="file1" type="file" class="TextField22" id="file1">
                          <span class="Estilo93">(950x395) px</span></td>
						...
						{
						?>
                        <span class="Estilo93">(<a href="../Publicaciones/l/<?=$Archivo?>" target="_blank">ver archivo</a> ) </span>
                        <?
						}
						?>
			...
			CKEDITOR.replace( 'Texto', {
              ...
              <td valign="top" class="Estilo93 Estilo96">&nbsp;</td>
            </tr>
          </table>
        </form></td>
      </tr>
