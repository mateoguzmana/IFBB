...
<table width="100%" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
  <tr>
    ...
    <td width="79%" class="itemselect">REGLAMENTO FISICO CULTURISMO</td>
...
<table width="99%" height="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="70%" align="left" valign="middle" bgcolor="#F7F7F7"><iframe src="ingfisico.php?dale=<?=$dale?>" width="98%" height="100%" frameborder="No" allowtransparency="true" id="empresa" name="empresa"></iframe></td>
    <td width="30%" align="center" valign="middle" bgcolor="#FFFFFF"><iframe src="actfisico.php" width="98%" height="100%" frameborder="No" allowtransparency="true"></iframe></td>
  </tr>
</table>
</body>
