...
$query0001="SELECT* FROM Videos where Id = '$Id'" ;
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingvideo.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actvideo3.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Titulo</span><br>
                      <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:95%" value="<?=$Nombre?>">
                      <br></td>
                    <td width="50%"><span class="Estilo93">Pos</span><br>
                      <input name="Pos" type="text" class="TextField22" id="Pos" value="<?=$Pos?>" size="2">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">Codigo de Youtube</span><br>
                     
                      <textarea name="Video" rows="4" class="TextField22" id="Video" style="width:95%"><?=$Video?></textarea></td>
                  </tr>
                </table>
                <br>
                <br>
