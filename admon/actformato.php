...
$(document).ready(function(){ 	
  ...
  $("#response").slideUp("slow", function () {
	...
	$("#list ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			var order = $(this).sortable("serialize") + '&update=update&tabla=ReglamentoM'; 
...
?>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="5%"><a href="actformato.php" class="Estilo93">Refrescar</a></td>
        </tr>
      </table>
      <hr width="99%" size="1">
      <p> </p>
...
<?
$query0001="SELECT* FROM ReglamentoM order by Pos" ;
...
<li id="arrayorder_<?php echo $Id0001 ?>">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="23%" align="center" valign="middle"><span class="Estilo93"><a href="actformato2.php?Id=<?=$Id0001?>" target="empresa">Act</a> / <a onClick=' return confirmSubmit()' href="eliformato.php?Id=<?=$Id0001?>">Elim</a></span></td>
        </tr>
        <tr>
