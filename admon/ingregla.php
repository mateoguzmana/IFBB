...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingregla2.php" method="post" enctype="multipart/form-data" name="fcalen">
...
<?
$query0001="SELECT* FROM Categoriasregla order by Pos" ;
