...
$sql="INSERT INTO  EventosR (Nombre, Fecha, Lugar)";
$sql.= "VALUES ('$Nombre', '$Fecha', '$Lugar')";
mysql_query($sql);


$query="SELECT* FROM EventosR Order By Id Asc";
...
(copy($archivo2, "../Eventos/r/".$foto0));

$query="UPDATE EventosR set Archivo='$foto0' Where Id='$Id'";
$result=mysql_query($query, $id);
}
?>
