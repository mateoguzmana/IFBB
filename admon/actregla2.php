...
$query0001="SELECT* FROM Reglamentos where Id = '$Id'" ;
...
$Id000w				=$row0001["Id"];
$Idcat				=$row0001["Idcat"];
$Nombre000w			=$row0001["Nombre"];
$Pos0001			=$row0001["Pos"];
$Archivo			=$row0001["Archivo"];
}

$query0001="SELECT* FROM Categoriasregla where Id = '$Idcat'" ;
$result0001=mysql_query($query0001, $id);

While($row0001=mysql_fetch_array($result0001))
{
$Nombrecat			=$row0001["Nombre"];
}
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
  <tr valign="middle" bordercolor="#FFFFFF">
    <td height="132" align="center" bordercolor="#F2F2F2"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="62" valign="top"><form action="actregla3.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
              <td width="20%" align="right"><a href="ingregla.php" class="Estilo93">Ingresar nuevo</a></td>
            </tr>
          </table>
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Categoria</span><br>
                      <select name="Idcat" class="TextField22" id="Idcat" style="width:99%">
                        <option value="<?=$Idcat?>" selected><?=$Nombrecat?></option>
                        <?
$query0001="SELECT* FROM Categoriasregla where Id <> '$Idcat' order by Pos" ;
$result0001=mysql_query($query0001, $id);
                    ...
                    <td height="30"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="50%" height="30"><span class="Estilo93">Nombre</span><br>
                          <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:99%" value="<?=$Nombre000w?>" ></td>
                        <td width="50%"><span class="Estilo93">Archivo PDF</span><br>
                          <input name="file2" type="file" class="TextField22" id="file2">
                          <?
                        if(!empty($Archivo))
						{
						?>
                          <span class="Estilo93">(<a href="../Reglamentos/<?=$Archivo?>" target="_blank">ver archivo</a> ) </span>
                          <?
						}
						?>
