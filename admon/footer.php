...
<table width="100%" border="0" bordercolor="#FFFFFF" cellpadding="0" cellspacing="0" background="Images/bg-seleccion.jpg">
  <tr>
    ...
    <td width="79%" class="itemselect">PIE DE PAGINA</td>
...
<table width="99%" height="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="middle" bgcolor="#F7F7F7"><iframe src="actfooter.php?dale=<?=$dale?>" width="98%" height="100%" frameborder="No" allowtransparency="true" id="empresa" name="empresa"></iframe></td>
  </tr>
</table>
</body>
