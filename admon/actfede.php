...
$(document).ready(function(){ 	
  ...
  $("#response").slideUp("slow", function () {
	...
	$("#list ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			var order = $(this).sortable("serialize") + '&update=update&tabla=Federaciones'; 
...
?>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="5%"><a href="actfede.php" class="Estilo93">Refrescar</a></td>
        </tr>
      </table>
      <hr width="99%" size="1">
      <p> </p>
...
<?
$query0001="SELECT* FROM Federaciones order by Pos" ;
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="75%" valign="middle" bgcolor="#EFEFEF"><span class="Estilo93" style="font-size: 8px"><?=$Nombre0001?></span><br>
            <img src="../Federaciones/p/<?=$Foto?>" width="91" height="42"></td>
          <td width="23%" align="center" valign="middle"><span class="Estilo93"><a href="actfede2.php?Id=<?=$Id0001?>" target="empresa">Act</a> / <a onClick=' return confirmSubmit()' href="elifede.php?Id=<?=$Id0001?>">Elim</a></span></td>
        </tr>
        <tr>
