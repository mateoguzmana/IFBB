...
<table width="99%" height="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="middle" bgcolor="#F7F7F7"><iframe src="actcontacto.php?dale=<?=$dale?>" width="100%" height="100%" frameborder="No" allowtransparency="true" id="empresa" name="empresa"></iframe></td>
  </tr>
</table>
</body>
