...
$query0001="SELECT* FROM ReglamentoI where Id = '$Id'" ;
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
  <tr valign="middle" bordercolor="#FFFFFF">
    <td height="132" align="center" bordercolor="#F2F2F2"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="62" valign="top"><form action="actinfografia3.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
              <td width="20%" align="right"><a href="inginfografia.php" class="Estilo93">Ingresar nuevo</a></td>
            </tr>
          </table>
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                  ...
                  <tr>
                    <td height="30"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="50%"><span class="Estilo93">Foto JPG</span><br>
                          <input name="file2" type="file" class="TextField22" id="file2">
                          <?
                        if(!empty($Archivo))
						{
						?>
                          <span class="Estilo93">(<a href="../Reglamento/i/<?=$Archivo?>" target="_blank">ver archivo</a> ) </span>
                          <?
						}
						?>
